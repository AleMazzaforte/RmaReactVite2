  ...
  return (
    <>
      ...
      <div className="p-4 max-w-6xl mx-auto bg-white rounded-lg shadow">
        ...
        <div>
          <button
            className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600 transition-colors flex items-center justify-center flex-1 fixed bottom-1 right-1 z-50"
            onClick={() =>
